	...
	<view class="container">
				...
				<tui-swipe-action :actions="actions" @click="handlerButton" :params="item">
					<template v-slot:content>
						<view class="tui-goods-item">
							<label class="tui-checkbox"><checkbox :value="item.id" :checked="item.selected" color="#fff"></checkbox></label>
							...
							<view class="tui-goods-info">
								...
								<view class="tui-price-box">
									...
									<view class="tui-scale"><tui-numberbox :value="item.buyNum" :height="40" :width="74" :min="1" :index="index" @change="changeNum"></tui-numberbox></view>
								</view>
							</view>
						</view>
					</template>
		...
		<view class="tui-cart-cell  tui-mtop">
			<view class="tui-activity">
				...
				<view class="tui-buy"><tui-button type="gray" :plain="true" shape="circle" width="200rpx" height="56rpx" :size="24">清空失效商品</tui-button></view>
			</view>
						...
						<view class="tui-goods-item">
							...
							<view class="tui-goods-info">
								...
								<view class="tui-price-box tui-flex-center">
									...
									<view class="tui-btn-alike"><tui-button type="white" :plain="true" shape="circle" width="120rpx" height="48rpx" :size="24">找相似</tui-button></view>
								</view>
							</view>
						</view>
					</template>
		...
		<view class="tui-tabbar">
			<view class="tui-checkAll">
				...
				<view class="tui-total-price" v-if="!isEdit">
					合计:
					<text class="tui-bold">￥{{ totalPrice | getPrice }}</text>
				</view>
			</view>
			<view>
