<template>
	<view class="container">
		<view class="tui-order-header">
			...
			<view class="tui-text">
				预计送达：
				<text class="tui-bold">5</text>
				月
				<text class="tui-bold">1</text>
				日
			</view>
		</view>
		<view class="tui-order-tracking">
			<tui-time-axis>
				...
				<tui-timeaxis-item backgroundColor="transparent">
					<template v-slot:node>
						<view class="tui-node"><tui-icon name="people" color="#fff" :size="13"></tui-icon></view>
					</template>
					<template v-slot:content>
				...
				<tui-timeaxis-item backgroundColor="transparent">
					<template v-slot:node>
						<view class="tui-node"><tui-icon name="transport" color="#fff" :size="13"></tui-icon></view>
					</template>
					<template v-slot:content>
				...
				<tui-timeaxis-item backgroundColor="transparent">
					<template v-slot:node>
						<view class="tui-node"><tui-icon name="home" color="#fff" :size="12"></tui-icon></view>
					</template>
					<template v-slot:content>
				...
				<tui-timeaxis-item backgroundColor="transparent">
					<template v-slot:node>
						<view class="tui-node"><tui-icon name="order" color="#fff" :size="12"></tui-icon></view>
					</template>
					<template v-slot:content>
				...
				<tui-timeaxis-item backgroundColor="transparent">
					<template v-slot:node>
						<view class="tui-node"><tui-icon name="notice" color="#fff" :size="12"></tui-icon></view>
					</template>
					<template v-slot:content>
