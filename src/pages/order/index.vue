		...
		<view :class="{ 'tui-order-list': scrollTop >= 0 }">
			<view class="tui-order-item" v-for="(model, orderIndex) in 3" :key="orderIndex">
				...
				<view class="tui-order-btn">
					...
					<view class="tui-btn-ml"><tui-button type="danger" plain width="152rpx" height="56rpx" :size="26" shape="circle">再次购买</tui-button></view>
				</view>
			</view>
			...
			<view class="tui-order-item">
				...
				<view class="tui-order-btn">
					<view class="tui-btn-ml"><tui-button type="black" plain width="152rpx" height="56rpx" :size="26" shape="circle">删除订单</tui-button></view>
					<view class="tui-btn-ml"><tui-button type="danger" plain width="152rpx" height="56rpx" :size="26" shape="circle">再次购买</tui-button></view>
				</view>
			</view>
		</view>
