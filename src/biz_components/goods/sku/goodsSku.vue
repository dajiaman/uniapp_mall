<template>
	<tui-bottom-popup :show="show" @close="closeSkuBox">
		
		<view class="tui-popup-box tui-padding">
			
			<tui-toast ref="toast"></tui-toast>
			
			<view class="tui-sku-header tui-padding">
		  ...
		  <view class="tui-right">
				<tui-icon name="close-fill" color="#999" :size="20" 
				@tap="closeSkuBox"></tui-icon>
			</view>
...
import skuRow from '@/biz_components/goods/sku/skuRow.vue';
import skuRowItem from '@/biz_components/goods/sku/skuRowItem.vue';
import skuStepper from '@/biz_components/goods/sku/skuStepper.vue';
import skuActions from '@/biz_components/goods/sku/skuActions.vue';
...
import skuEventBus from '@/utils/eventbus.js';
